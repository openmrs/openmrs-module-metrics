...
import org.openmrs.module.metrics.api.dao.MetricsDao;
...
/**
 * This is a unit test, which verifies logic in MetricsService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class MetricsServiceTest {
	
	@InjectMocks
	MetricsServiceImpl basicModuleService;
